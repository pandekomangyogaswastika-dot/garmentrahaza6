      ...
      {showModal && (
        <Modal title={editData ? 'Edit Produk' : 'Tambah Produk'} onClose={() => setShowModal(false)}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">CMT Price (Rp)</label>
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Selling Price (Rp)</label>
